...
FILMS=DATA['films']; E=html.escape
...
def head(title,root='',world='film',home=False,page_path=''):
    canonical='https://lakaaysha.com/'+page_path
    metadata=f'<link rel="canonical" href="{canonical}"><meta property="og:type" content="website"><meta property="og:title" content="{E(title)}"><meta property="og:description" content="Lakaaysha van Ewijk. Film director, visual artist and author. Amsterdam."><meta property="og:url" content="{canonical}"><meta property="og:image" content="https://lakaaysha.com/media/heron-4.webp"><meta name="twitter:card" content="summary_large_image">'
    return f'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{E(title)}</title><meta name="description" content="Lakaaysha van Ewijk. Film director, visual artist and author. Amsterdam.">{metadata}<meta name="robots" content="{'noindex' if page_path=='404.html' else 'index,follow'}"><meta name="portfolio-version" content="2026-09-11-cursor"><meta name="theme-color" content="{'#96254f' if world=='ink' else '#211425'}"><link rel="icon" href="{root}favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="{root}fonts.css"><link rel="stylesheet" href="{root}style.css"><script src="{root}app.js" defer></script></head><body class="world-{world}{' homepage' if home else ''}" data-root="{root}"><a class="skip" href="#main">Skip to content</a><header class="site-header" id="top"><a class="identity" href="{root}index.html">Lakaaysha van Ewijk</a><nav aria-label="Main navigation"><a href="{root}index.html#films" {'aria-current="page"' if world=='film' else ''}>Films</a><a href="{root}ink/index.html" {'aria-current="page"' if world=='ink' else ''}>Writing</a><a href="#contact">Contact</a></nav></header>'''
...
home+='<section class="press" id="press"><h2>Press &amp; programmes</h2><div>'+''.join(outside(p['url'],p['label']) for p in DATA['press'])+'</div></section>'+contact()+'</main>'+footer()
write(Path('index.html'),home)
writing=head('Lakaaysha van Ewijk | Writing','../','ink',page_path='ink/')
